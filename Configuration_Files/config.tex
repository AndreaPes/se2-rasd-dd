...
%For costumized list
\newlist{featurelist}{itemize}{1}
\setlist[featurelist]{label=[\textbf{F1}]}
\newcommand\itemdb{\item[{[\textbf{F2}]}]}
\newcommand\itemdc{\item[{[\textbf{F3}]}]}
\newcommand\itemdd{\item[{[\textbf{F4}]}]}
\newcommand\itemde{\item[{[\textbf{F5}]}]}
\newcommand\itemdf{\item[{[\textbf{F6}]}]}
\newcommand\itemdg{\item[{[\textbf{F7}]}]}
\newcommand\itemdh{\item[{[\textbf{F9}]}]}
\newcommand\itemdh{\item[{[\textbf{F10}]}]}
\newcommand\itemdh{\item[{[\textbf{F11}]}]}
\newcommand\itemdh{\item[{[\textbf{F12}]}]}
\newcommand\itemdh{\item[{[\textbf{F13}]}]}
\newcommand\itemdh{\item[{[\textbf{F14}]}]}
